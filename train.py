...
print("Mario")
mario_text = parse_folder(blend + "/" + game[0] + "/",orient[0],9)
print("Icarus")
icarus_text = parse_folder(blend + "/" + game[1] + "/",orient[1],21)
...
print('mario sequences:', len(mario_sentences))
...
print('icarus sequences:', len(icarus_sentences))
...
if weighted:
    ...
    for iteration in range(1,51):
        ...
        if va > best_val_acc:
            ...
            model_name = 'model_mario' + '_' + blend + '_weighted'
    ...
    for iteration in range(1,51):
        ...
        if va > best_val_acc:
            best_val_acc = va
            print("IMPROVED! New best validation acc: ", best_val_acc)
            model_name = 'model_icarus' + '_' + blend + '_weighted'
    ...
    for iteration in range(1,51):
        ...
        if va > best_val_acc:
            best_val_acc = va
            print("IMPROVED! New best validation acc: ", best_val_acc)
            model_name = 'model_combined_' + blend
